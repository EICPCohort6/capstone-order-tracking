...
const config = {
  database: "capstone-customer-manager.mysql.database.azure.com",//process.env.mySqlHostName,
  username: "csr_root", //process.env.mySqlUser,
  password: "Password1" //process.env.mySqlPass,
};
